...
<details>
<summary>func_tool</summary>

```bash
# struct
# 1. 定义 结构体 ,为 *structName 类型定义了一个 test 方法。
struct -> func (r *structName) test()(){}
# 2. 定义 test 函数,形参为结构体,将数据传回 struct
func test(config *structConfig) []string {} -> struct
```
...
<details>
<summary>func_tool adk_agent_main</summary>
...
<details>
<summary>func_ToolsNode_main</summary>
